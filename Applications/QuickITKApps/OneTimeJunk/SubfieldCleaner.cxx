...
int main(int argc, char *argv[])
{
  ...
  if(argc < 4)
    {
    cout << "subfield_cleaner input_image output_image label_ids" << endl;
    return -1;
    }
  ...
  fReader->Update();
  ImageType::Pointer src = fReader->GetOutput();

  // Get the list of labels that require cleaning
